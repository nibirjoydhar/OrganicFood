      ...
      <div class="bg-white rounded-lg shadow p-6 mb-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <div
            ...
            :class="{
              'bg-yellow-100 text-yellow-800': order.status === 'pending' || order.status === 'payment_pending',
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p
                class="font-medium"
                :class="{
                  'text-green-600': order.payment.status === 'completed',
                  'text-yellow-600': order.payment.status === 'pending',
                  'text-red-600': ['failed', 'cancelled'].includes(order.payment.status),
                }"
              >
        ...
        <div v-if="['payment_failed', 'payment_cancelled'].includes(order.status)" class="mt-4">
          <Link
            :href="route('customer.payment.initiate', order.id)"
            method="post"
